...
function TestProgress() {
  ...
  const [pictures, setPictures] = React.useState(
    Array.from(new Array(count)).map((e, i) => i),
  );
        ...
        {pictures.map((e, i) => (
          <div
            style={{
              ...
              '2px solid green': '2px solid black',
              background: i >= range[0] && i <= range[1] ? 'green' : 'white',
              margin: 20,
            }}
...
storiesOf('tests', module).add('progress', () => <TestProgress />);
